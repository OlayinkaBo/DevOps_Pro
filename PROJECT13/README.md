...
**After editing**
![alt text](<Images/roles edited.png>)
...
![alt text](<Images/git branch merged.PNG>)
...
![alt text](<Images/site yml for lb.png>)
...
![alt text](<Images/nginx-lb config.png>)
